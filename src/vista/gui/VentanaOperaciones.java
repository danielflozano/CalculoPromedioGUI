	...
	private void capturarDatos() {
		...
		try {
			if (txtDocumento.getText().isEmpty() || txtNombre.getText().isEmpty() || 
		            txtNota1.getText().isEmpty() || txtNota2.getText().isEmpty() || txtNota3.getText().isEmpty()) {
			...
			if ((nota1 >= 0 && nota1 <= 5) && (nota2 >= 0 && nota2 <= 5) && (nota3 >= 0 && nota3 <= 5)) {			
				...
				if (definitiva.equals("Reprobado")) {
				...
				if (mensaje.equals("Error, la persona ya se encuentra registrada")) {
					return;
				...
				JOptionPane.showMessageDialog(null, "Las notas deben ser números entre 0 y 5");
				
			}
			
		} catch (NumberFormatException e) {
			JOptionPane.showMessageDialog(null, "Ingrese datos validos, las notas deben ser números");
